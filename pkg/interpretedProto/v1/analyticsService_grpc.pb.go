...
type AnalyticsClient interface {
	...
	UpdateTasksState(ctx context.Context, in *NewTasksState, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *analyticsClient) UpdateTasksState(ctx context.Context, in *NewTasksState, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, "/interpretedProto.Analytics/UpdateTasksState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AnalyticsServer interface {
	...
	UpdateTasksState(context.Context, *NewTasksState) (*emptypb.Empty, error)
...
func (UnimplementedAnalyticsServer) UpdateTasksState(context.Context, *NewTasksState) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateTasksState not implemented")
}
...
func _Analytics_UpdateTasksState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(NewTasksState)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AnalyticsServer).UpdateTasksState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/interpretedProto.Analytics/UpdateTasksState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AnalyticsServer).UpdateTasksState(ctx, req.(*NewTasksState))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Analytics_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Analytics_UpdateTasksState_Handler,
		},
		{
